...
// 画像の描画
//最初は何も表示されておりません。
//インデックスデータを正確に入れて初めて何か表示されます。
int DrawChangingPictures( void )
{
	CUSTOMVERTEX			Vertices[4];
	WORD					wIndices[6]={0,1,2,2,3,1};	// インデックスデータ
	...
	// 頂点インデックスを使って描画…なんだけど、今、インデックスデータは入っておりません。
	//　インデックスについて学び、理解した上で、上のインデックスデータに数値を入れて、オブジェクトを表示してください。
