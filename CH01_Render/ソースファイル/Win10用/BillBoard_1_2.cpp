...
XMMATRIX MakeBillboardMatrix( XMMATRIX *pmatView )
{
	...
	matBill.r[0].m128_f32[3] = pmatView->r[3].m128_f32[0];
	matBill.r[1].m128_f32[0] = -pmatView->r[0].m128_f32[1];
	matBill.r[2].m128_f32[0] = -pmatView->r[0].m128_f32[2];
	matBill.r[3].m128_f32[0] = -pmatView->r[0].m128_f32[3];
	matBill.r[1].m128_f32[1] = -pmatView->r[2].m128_f32[2];
	matBill.r[2].m128_f32[2] = -pmatView->r[1].m128_f32[1];
