...
{
	XMMATRIX		matBill=XMMatrixIdentity();	// ビルボード行列が最終的に入る

	// 回転部分の転置行列作成
	// 逆行列関数を使うのではなく、転置をする。
	// matBillを中間変数とみなして、転置行列を作りましょう。
	// なお、回転成分だけを活かしたいので4行目、4列目を単位行列状態とする。
	...
	//matBill.r[3].m128_f32[0] = pmatView->r[3].m128_f32[0];
	//matBill.r[3].m128_f32[1] = pmatView->r[3].m128_f32[1];
	//matBill.r[3].m128_f32[2] = pmatView->r[3].m128_f32[2];
	//matBill.r[3].m128_f32[3] = 1;
