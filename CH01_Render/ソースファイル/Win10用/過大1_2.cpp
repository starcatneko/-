...
int InitArea( void )
{
	...
	HitArea.fRot_z = PI / float((rand()*100000)%360);
	_RPT1(_CRT_WARN, "\n%f\n", HitArea.fRot_z);
...
int MovePlayer( void )									// 球の移動
{
	...
	*/
	...
	Player_1.v3Pos.z += PLAYER_SPEED * 2;
	if(Player_1.v3Pos.z > 5.0f)
	{
		Player_1.v3Pos.z = -16.0f;
		InitArea();
	}
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
    ...
    g_hWnd = CreateWindow( _T( "D3D Sample" ), _T("課題1_2 1601291 西岡豊" ),
