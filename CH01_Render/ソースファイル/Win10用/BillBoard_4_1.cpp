...
XMMATRIX MakeDirectMatrix( XMFLOAT3 *pv3Start, XMFLOAT3 *pv3End )
{
	...
	//v3Side.x = v3Foward.x*matArrowWorld.r[1].m128_f32[1]+ v3Foward.y*matArrowWorld.r[2].m128_f32[1]+ v3Foward.z*matArrowWorld.r[3].m128_f32[1];
	matArrowWorld.r[0].m128_f32[1] = v3Foward.x;
	matArrowWorld.r[1].m128_f32[1] = v3Foward.y;
	matArrowWorld.r[2].m128_f32[1] = v3Foward.z;
...
HRESULT MakeShaders( void )
{
    ...
    hr = D3DCompileFromFile( _T( "Basic_3D_TexMark.fx" ), nullptr, nullptr, "VS", "vs_4_0_level_9_1",
								dwShaderFlags, 0, NULL, &pVertexShaderBuffer );
    if ( FAILED( hr ) ) {
    ...
    hr = D3DCompileFromFile( _T( "Basic_3D_TexMark.fx" ), nullptr, nullptr, "PS", "ps_4_0_level_9_1",
								dwShaderFlags, 0, NULL, &pPixelShaderBuffer );
    if ( FAILED( hr ) ) {
...
{
    HRESULT						hr;
	D3D11_IMAGE_LOAD_INFO		liLoadInfo;
	...
	hr = D3D11CreateShaderResourceViewFromFile( g_pd3dDevice, szFileName, &liLoadInfo,
